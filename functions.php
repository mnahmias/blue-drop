...
// Register Board Members Post Type
function board_members_post_type() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Board Member', 'text_domain' ),
		'archives'              => __( 'Board Member Archives', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Board Member:', 'text_domain' ),
		'all_items'             => __( 'All Board Members', 'text_domain' ),
		'add_new_item'          => __( 'Add New Team Member', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
		'new_item'              => __( 'New Board Member', 'text_domain' ),
		...
		'search_items'          => __( 'Search Board Member', 'text_domain' ),
		'not_found'             => __( 'Not found', 'text_domain' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'text_domain' ),
		'featured_image'        => __( 'Featured Image', 'text_domain' ),
		'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
		...
		'insert_into_item'      => __( 'Insert into Service', 'text_domain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Service', 'text_domain' ),
		'items_list'            => __( 'Board Members list', 'text_domain' ),
		'items_list_navigation' => __( 'Board Members list navigation', 'text_domain' ),
		'filter_items_list'     => __( 'Filter Board Members list', 'text_domain' ),
	);
	$args = array(
		'label'                 => __( 'Board Member', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( ),
		'hierarchical'          => false,
		'public'                => true,
