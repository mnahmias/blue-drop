...
<?php while (have_posts()) : the_post(); ?>
  ...
  if ( $query->have_posts() ) { ?>
	  <div class="gallery" id="testimonials_gallery">
	    <?php foreach ($query->posts as $post) { ?>
			    <div id="<?php echo $post->post_name;?>" class="gallery-item">
			      <div class="gallery-item__container">
			        <div class="gallery-item__image" style="background-image:url('<?php the_field('hero_image'); ?>')"><a class="gallery-item__image-link" href="<?php the_permalink(); ?>"></a></div>
