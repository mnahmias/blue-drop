<?php while (have_posts()) : the_post(); ?>
	<div class="hero--rain">
		<canvas class="hero--rain__canvas" id="raindrops"> </canvas>
		<h1 class="hero--rain__title">Blue Drop</h1>
		<svg class="hero--rain__logo" width="338px" height="247px" viewBox="0 0 338 247">
		    <defs>
		        <path id="path-1" d="M0.403,73.94 L113.919,73.94 L113.919,37.3995 L113.919,0.859 L0.403,0.859 L0.403,73.94 L0.403,73.94 Z"></path>
		    </defs>
		    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		        <g id="blue_drop" transform="translate(1.000000, 0.000000)">
		            ...
		            <g id="Group-13" transform="translate(223.000000, 173.000000)">
		...
		<p class="hero--rain__lede">We have a special feeling toward the other planets that circle our sun. Maybe it’s all the science fiction stories about visiting the moon.</p>
	</div>
	<div class="container">
		<div class="featured-intro scroll-item">
			<h2 class="featured-intro__title">What We Do</h2>
			<p class="featured-intro__content">We have a special feeling toward the other planets that circle our sun. Maybe it’s all the science fiction stories about visiting the moon.</p>
		</div>
	</div>
	...
	if( $query->have_posts() ) : while( $query->have_posts() ) : $query->the_post(); ?>
			...
			<div class="featured-posts__post scroll-item">
				<div class="featured-posts__post-container">
					<div class="featured-posts__image" style="background-image:url('<?php the_field('service_image'); ?>')"></div>
					<div class="featured-posts__content">
						<h2 class="featured-posts__title"><?php the_title(); ?></h2>
						<p class="featured-posts__intro"><?php the_field('intro_content'); ?></p>
						<a class="featured-posts__button" href="./services#<?php echo $post->post_name;?>">Read More</a>
					</div>
				</div>
			</div>
	...
	<?php endwhile; wp_reset_postdata(); endif; ?>
			...
			<div class="scroll-item">
				<img class="scrolling-lines" src="./wp-content/themes/blue-drop/dist/images/scrolling-lines.png" />
			</div>
	...
	if( $query->have_posts() ) : while( $query->have_posts() ) : $query->the_post(); ?>
			...
			<div class="featured-posts__post--left scroll-item">
				<div class="featured-posts__post-container">
					<div class="featured-posts__image--left" style="background-image:url('<?php the_field('service_image'); ?>')"></div>
					<div class="featured-posts__content--left">
						<h2 class="featured-posts__title"><?php the_title(); ?></h2>
						<p class="featured-posts__intro"><?php the_field('intro_content'); ?></p>
						<a class="featured-posts__button" href="./services#<?php echo $post->post_name;?>">Read More</a>
					</div>
	...
	<?php endwhile; wp_reset_postdata(); endif; ?>
			...
			<div class="scroll-item">
				<img class="scrolling-lines--left" src="./wp-content/themes/blue-drop/dist/images/scrolling-lines.png" />
			</div>
	...
	<?php endwhile; wp_reset_postdata(); endif; ?>
			<div class="cta--center scroll-item">
				<a class="button--large--inverse" href="./services">View All Services</a>
			</div>
		</div>
	</div>
<?php endwhile; ?>
